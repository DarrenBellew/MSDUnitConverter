...
//CODE SNIPPET REFERENCE: http://stackoverflow.com/questions/3422673/evaluating-a-math-expression-given-in-string-form
//Answer 2 ^
...
public class MathsParser {
    ...
    private static double eval(final String formula) {
        class Parser {
            ...
            void eatChar() {
                c = (++pos < formula.length()) ? formula.charAt(pos) : -1;
            }
